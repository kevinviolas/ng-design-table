...
var PriorityComponent = /** @class */ (function () {
    ...
    PriorityComponent = __decorate([
        Component({
            ...
            styles: [".now-low{background:no-repeat padding-box rgba(17,150,3,.56)!important;border-radius:5px;border:none!important;text-align:left;color:#fff!important;font:14px/36px sans-serif;letter-spacing:0;min-width:0!important;padding:0 10px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px}.now-normal{background:no-repeat padding-box rgba(170,238,230,.56)!important;border-radius:5px;border:none!important;text-align:left;font:14px/36px sans-serif;letter-spacing:0;color:#169d8a!important;min-width:0!important;padding:0 10px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px}.now-urgent{background:no-repeat padding-box rgba(243,161,36,.56)!important;border-radius:5px;border:none!important;text-align:left;font:14px/36px sans-serif;letter-spacing:0;color:#c48e3b!important;min-width:0!important;padding:0 10px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px}.now-critic{background:no-repeat padding-box rgba(215,5,43,.56)!important;border-radius:5px;border:none!important;text-align:left;font:14px/36px sans-serif;letter-spacing:0;color:#7c1c2d!important;min-width:0!important;padding:0 10px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px}.now-vip{background:no-repeat padding-box rgba(120,125,130,.56)!important;border-radius:5px;border:none!important;text-align:left;font:12px/36px nexa;letter-spacing:0;color:#171f26!important;min-width:0!important;padding:0 10px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px}"]
        }),
        __metadata("design:paramtypes", [TableService])
    ], PriorityComponent);
